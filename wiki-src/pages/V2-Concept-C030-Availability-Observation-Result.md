...
> Persistent information object recording observed/reported medicine availability in context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C030` |
| Domain | [[V2 Module 06 Ecosystem Observation|Ecosystem Observation]] |
| Layer | Core |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:AvailabilityObservationResult` |
...
- Current SHACL source does not directly reference `cmpe:AvailabilityObservationResult`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P5/ESMP + P1/P2 context
- **Held-out evidence:** H2 partial
- **Other support:** O3/M1/M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/030-availability-observation-result.md`
