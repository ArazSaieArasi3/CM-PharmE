...
> Medicinal/active substance identity distinct from product identity and presentation.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C017` |
| Domain | [[V2 Module 04 Pharmaceutical Product|Pharmaceutical Product]] |
| Layer | Core |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:PharmaceuticalSubstance` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property hasActiveSubstance|`hasActiveSubstance`]] | unspecified | explicit range; domain unspecified |

Properties whose endpoint is formally unspecified are not inferred into this list.

## Constraints / SHACL relevance
- Protected conceptual distinction(s): `PharmaceuticalSubstance ≠ MedicinalProduct`.
- Current SHACL source does not directly reference `cmpe:PharmaceuticalSubstance`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/P4/P5/P6/S1
...
- Concept Evidence Passport: `v2/review/concepts/passports/017-pharmaceutical-substance.md`
