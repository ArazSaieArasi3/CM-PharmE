...
> Normative information object specifying intended actions/controls for addressing risk/vulnerability.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C077` |
| Domain | [[V2 Module 13 Risk Management|Risk Management]] |
| Layer | Extension |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:RiskTreatmentPlan` |
...
- Current SHACL source does not directly reference `cmpe:RiskTreatmentPlan`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0028 broad → W4 split
...
- Concept Evidence Passport: `v2/review/concepts/passports/077-risk-treatment-plan.md`
