...
| Field | Value |
|---|---|
| IRI | `cmpe:withinRegion` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C033 Geographic Feature|GeographicFeature]] |
| Range | [[V2 Concept C034 Administrative Region|AdministrativeRegion]] |
| Formal layer | X-INFRA |

## Semantic / review note
Geographic containment/context

## Related concepts
- **Domain/source:** [[V2 Concept C033 Geographic Feature|GeographicFeature]]
- **Range/target:** [[V2 Concept C034 Administrative Region|AdministrativeRegion]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C033 Geographic Feature|GeographicFeature]] — `withinRegion` → [[V2 Concept C034 Administrative Region|AdministrativeRegion]]
