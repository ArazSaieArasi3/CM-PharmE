...
> Information object describing a service offering in the optional business/application view.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C085` |
| Domain | [[V2 Module 15 Business Architecture|Business Architecture]] |
| Layer | Extension |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ServiceOfferingSpecification` |
...
- Current SHACL source does not directly reference `cmpe:ServiceOfferingSpecification`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** V1
- **Held-out evidence:** —
- **Other support:** PR1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0039 → retain/move
...
- Concept Evidence Passport: `v2/review/concepts/passports/085-service-offering-specification.md`
