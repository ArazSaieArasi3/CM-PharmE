...
| Field | Value |
|---|---|
| IRI | `cmpe:authorizationJurisdiction` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C014 Regulatory Authorization|RegulatoryAuthorization]] |
...
## Related concepts
- **Domain/source:** [[V2 Concept C014 Regulatory Authorization|RegulatoryAuthorization]]
...
## Structural example
[[V2 Concept C014 Regulatory Authorization|RegulatoryAuthorization]] — `authorizationJurisdiction` → [[V2 Concept C015 Regulatory Jurisdiction|RegulatoryJurisdiction]]
