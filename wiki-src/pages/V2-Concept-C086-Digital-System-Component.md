...
> Generic digital/information-system component used in ecosystem applications without technology-specific Core commitment.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C086` |
| Domain | [[V2 Module 16 Digital Systems|Digital Systems]] |
| Layer | Extension |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:DigitalInformationSystemComponent` |
...
- Current SHACL source does not directly reference `cmpe:DigitalInformationSystemComponent`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** V1 lineage
- **Held-out evidence:** —
- **Other support:** PR1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0029/C0030/C0031/C0033/C0035/C0038 → generalize/deprecate specific forms
...
- Concept Evidence Passport: `v2/review/concepts/passports/086-digital-system-component.md`
