...
> Symbolic identifier value under a defined scheme; not itself entity identity.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C053` |
| Domain | [[V2 Module 09 Entity Identity|Entity Identity]] |
| Layer | X-INFRA |
| OntoUML stereotype | Datatype |
| Formal entity type | RDFS Datatype |
| Formal IRI | `cmpe:IdentifierValue` |
...
- Current SHACL source does not directly reference `cmpe:IdentifierValue`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1–P7/C2/S1
- **Held-out evidence:** H2 exact with presentation identity
- **Other support:** M1/M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/053-identifier-value.md`
