...
> Facility role when used for distribution, storage, handling, or 3PL operations.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C011` |
| Domain | [[V2 Module 02 Facility Operations|Facility Operations]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:DistributionSiteRole` |
...
- Current SHACL source does not directly reference `cmpe:DistributionSiteRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Review focus:** anti-rigid facility role and separation from facility identity and organization roles.
...
- Concept Evidence Passport: `v2/review/concepts/passports/011-distribution-site.md`
