...
| Field | Value |
|---|---|
| IRI | `cmpe:contextClassificationEntry` |
...
| Range | [[V2 Concept C023 Classification Entry|ClassificationEntry]] |
...
- **Range/target:** [[V2 Concept C023 Classification Entry|ClassificationEntry]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C060 Contextual Medicine Classification Assignment|ContextualMedicineClassificationAssignment]] — `contextClassificationEntry` → [[V2 Concept C023 Classification Entry|ClassificationEntry]]
