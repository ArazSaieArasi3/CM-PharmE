...
> Identified vocabulary/scheme used to classify products or substances.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C022` |
| Domain | [[V2 Module 04 Pharmaceutical Product|Pharmaceutical Product]] |
| Layer | Core |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ProductClassificationScheme` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property entryInScheme|`entryInScheme`]] | ClassificationEntry | explicit range and domain |
...
- Current SHACL source does not directly reference `cmpe:ProductClassificationScheme`. This is a syntactic reference observation, not a completeness judgment.
...
## Structural example
`ClassificationEntry` — `entryInScheme` → `ProductClassificationScheme`
...
- Concept Evidence Passport: `v2/review/concepts/passports/022-product-classification-scheme.md`
