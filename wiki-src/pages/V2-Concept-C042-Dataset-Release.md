...
> Identified dataset version/snapshot used for reproducible analysis.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C042` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:DatasetRelease` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property hasDatasetRelease|`hasDatasetRelease`]] | Dataset | explicit range and domain |
| Outgoing | [[V2 Object Property containsSourceRecord|`containsSourceRecord`]] | cmpe:SourceRecord | explicit domain and range |
...
- Current SHACL source does not directly reference `cmpe:DatasetRelease`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1–P7
- **Held-out evidence:** H3 exact list/version support
- **Other support:** M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0038 broad → new infrastructure
- See [[V1 to V2 Concept Migration]] and [[V1 to V2 Research Evolution]] for cross-version interpretation.

## Structural example
`Dataset` — `hasDatasetRelease` → `DatasetRelease`
...
- Concept Evidence Passport: `v2/review/concepts/passports/042-dataset-release.md`
