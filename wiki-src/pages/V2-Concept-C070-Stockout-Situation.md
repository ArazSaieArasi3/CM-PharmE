...
> State in which required pharmaceutical stock is unavailable in operational context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C070` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Situation |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:StockoutSituation` |
...
- Current SHACL source does not directly reference `cmpe:StockoutSituation`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** C1 + P5 framing
- **Held-out evidence:** —
...
- Concept Evidence Passport: `v2/review/concepts/passports/070-stockout-situation.md`
