...
> Observation result recording reimbursement and/or utilization evidence in defined population/period/access context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C072` |
| Domain | [[V2 Module 12 Market Access|Market Access]] |
| Layer | Extension |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ReimbursementUtilisationObservationResult` |
...
- Current SHACL source does not directly reference `cmpe:ReimbursementUtilisationObservationResult`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/S2
- **Held-out evidence:** —
- **Other support:** M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** New extension
...
- Concept Evidence Passport: `v2/review/concepts/passports/072-reimbursement-and-utilization-observation-result.md`
