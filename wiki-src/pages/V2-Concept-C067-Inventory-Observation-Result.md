...
> Observation result recording inventory/stock information in operational context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C067` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:InventoryObservationResult` |
...
- Current SHACL source does not directly reference `cmpe:InventoryObservationResult`. This is a syntactic reference observation, not a completeness judgment.
...
- Concept Evidence Passport: `v2/review/concepts/passports/067-inventory-observation-result.md`
