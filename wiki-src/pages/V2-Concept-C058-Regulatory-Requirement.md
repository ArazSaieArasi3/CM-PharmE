...
> Normative information object expressing a regulatory obligation/rule applicable in context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C058` |
| Domain | [[V2 Module 10 Regulatory Policy|Regulatory Policy]] |
| Layer | Extension |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:RegulatoryRequirement` |
...
- Current SHACL source does not directly reference `cmpe:RegulatoryRequirement`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P3/P5/C2
- **Held-out evidence:** —
- **Other support:** PR1/O1/O2/O4/M1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0027; broader C0036 lineage → refine
...
- Concept Evidence Passport: `v2/review/concepts/passports/058-regulatory-requirement.md`
