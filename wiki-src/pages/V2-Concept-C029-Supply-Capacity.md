...
> Disposition/capacity inhering in an organization or facility to provide, manufacture, or supply medicines.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C029` |
| Domain | [[V2 Module 05 Supply Operations|Supply Operations]] |
| Layer | Core |
| OntoUML stereotype | Mode |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:SupplyCapacity` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property capacityBearer|`capacityBearer`]] | unspecified | explicit domain; range unspecified |

Properties whose endpoint is formally unspecified are not inferred into this list.

## Constraints / SHACL relevance
- Protected conceptual distinction(s): `SupplyCapacity ≠ SupplyCapacityObservationResult`.
- Current SHACL source does not directly reference `cmpe:SupplyCapacity`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P5/C1
- **Held-out evidence:** —
- **Other support:** PR1/O3/O4/M1/M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/029-supply-capacity.md`
