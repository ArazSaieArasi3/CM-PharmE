...
> Assertion that source representations correspond to the same or related real-world entity.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C056` |
| Domain | [[V2 Module 09 Entity Identity|Entity Identity]] |
| Layer | X-INFRA |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:EntityMatchAssertion` |

## Generalization
[[V2 Concept C044 Assertion|Assertion]]

## Principal formal relations
| Direction | Property | Other endpoint | Constraint status |
|---|---|---|---|
| Outgoing | [[V2 Object Property matchSubject|`matchSubject`]] | unspecified | explicit domain; range unspecified |
| Outgoing | [[V2 Object Property matchObject|`matchObject`]] | unspecified | explicit domain; range unspecified |
| Outgoing | [[V2 Object Property hasMatchConfidence|`hasMatchConfidence`]] | cmpe:MatchConfidence | explicit domain and range |
...
- Current SHACL source does not directly reference `cmpe:EntityMatchAssertion`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P3/P4/P7 overlap + W1 need
- **Held-out evidence:** —
- **Other support:** M2
...
## Structural example
`EntityMatchAssertion` — `hasMatchConfidence` → `cmpe:MatchConfidence`
...
- Concept Evidence Passport: `v2/review/concepts/passports/056-entity-match-assertion.md`
