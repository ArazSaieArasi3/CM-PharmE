...
| Field | Value |
|---|---|
| IRI | `cmpe:baViewRepresents` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C082 Business Architecture View|BusinessArchitectureView]] |
| Range | `unspecified` |
| Formal layer | Extension |

## Semantic / review note
Representation target; range review required

## Related concepts
- **Domain/source:** [[V2 Concept C082 Business Architecture View|BusinessArchitectureView]]
