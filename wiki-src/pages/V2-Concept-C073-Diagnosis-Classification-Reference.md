...
> Information object representing diagnosis code/category used to contextualize utilization/access evidence.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C073` |
| Domain | [[V2 Module 12 Market Access|Market Access]] |
| Layer | Extension |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:DiagnosisClassificationReference` |
...
- Current SHACL source does not directly reference `cmpe:DiagnosisClassificationReference`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2
...
- Concept Evidence Passport: `v2/review/concepts/passports/073-diagnosis-classification-reference.md`
