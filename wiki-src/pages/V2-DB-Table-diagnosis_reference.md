...
## Purpose
Diagnosis-classification reference used by market-access/observation data.

## Keys and structure
- **Primary key:** `diagnosis_reference_id`
- **Foreign keys:** 0
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/DiagnosisClassificationReference` | class | direct | `diagnosis_reference_id` | Market-access extension reference |
...
`{"diagnosis_reference_id": "1001", "public_id": "syn-diagnosis-reference-001", "scheme": "synthetic-scheme", "code": "synthetic-code", "label": "synthetic-label", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
