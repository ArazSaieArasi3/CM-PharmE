...
> Organization role acting as payer, funder, or healthcare-financing actor in access/reimbursement.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C071` |
| Domain | [[V2 Module 12 Market Access|Market Access]] |
| Layer | Extension |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:PayerFundingOrganizationRole` |
...
- Current SHACL source does not directly reference `cmpe:PayerFundingOrganizationRole`. This is a syntactic reference observation, not a completeness judgment.
...
- Concept Evidence Passport: `v2/review/concepts/passports/071-healthcare-financing-organization.md`
