...
> Administrative/reporting area specialized from Geographic Feature.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C034` |
| Domain | [[V2 Module 07 Spatiotemporal Context|Spatiotemporal Context]] |
| Layer | X-INFRA |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:AdministrativeRegion` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property withinRegion|`withinRegion`]] | GeographicFeature | explicit range and domain |
...
- Current SHACL source does not directly reference `cmpe:AdministrativeRegion`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/P7
- **Held-out evidence:** —
- **Other support:** M1/M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/034-administrative-region.md`
