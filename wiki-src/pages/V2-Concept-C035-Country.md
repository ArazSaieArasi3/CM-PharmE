...
> Country-level geographic/political reference specialized from Geographic Feature.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C035` |
| Domain | [[V2 Module 07 Spatiotemporal Context|Spatiotemporal Context]] |
| Layer | X-INFRA |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:Country` |

## Generalization
[[V2 Concept C033 Geographic Feature|GeographicFeature]]

## Principal formal relations
| Direction | Property | Other endpoint | Constraint status |
|---|---|---|---|
| Incoming | [[V2 Object Property withinCountry|`withinCountry`]] | GeographicFeature | explicit range and domain |
...
- Current SHACL source does not directly reference `cmpe:Country`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P3/P5/P7
- **Held-out evidence:** H1 exact; H3 exact
- **Other support:** O1/O4/M1/M2
...
## Structural example
`GeographicFeature` — `withinCountry` → `Country`
...
- Concept Evidence Passport: `v2/review/concepts/passports/035-country.md`
