...
> Observation result recording procurement/replenishment/delivery lead-time information.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C069` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:LeadTimeObservationResult` |
...
- Current SHACL source does not directly reference `cmpe:LeadTimeObservationResult`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** C1
- **Held-out evidence:** —
- **Other support:** M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** New conditional
...
- Concept Evidence Passport: `v2/review/concepts/passports/069-lead-time-observation-result.md`
