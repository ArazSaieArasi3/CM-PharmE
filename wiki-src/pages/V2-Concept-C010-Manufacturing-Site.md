...
> Facility role when used or authorized for pharmaceutical manufacturing/processing.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C010` |
| Domain | [[V2 Module 02 Facility Operations|Facility Operations]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ManufacturingSiteRole` |

## Generalization
[[V2 Concept C009 Facility|Facility]], [[V2 Concept C002 Ecosystem Participant|EcosystemParticipant]]
...
- Current SHACL source does not directly reference `cmpe:ManufacturingSiteRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Review focus:** anti-rigid facility role; distinguish site identity from manufacturing use/authorization.
...
- Concept Evidence Passport: `v2/review/concepts/passports/010-manufacturing-site.md`
