...
> Regulated Organization role providing third-party pharmaceutical logistics.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C008` |
| Domain | [[V2 Module 01 Ecosystem Organization|Ecosystem Organization]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ThirdPartyLogisticsProviderRole` |
...
- Current SHACL source does not directly reference `cmpe:ThirdPartyLogisticsProviderRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** contextual dependence and distinction from Wholesale Distributor and logistics activities/sites.
...
- Concept Evidence Passport: `v2/review/concepts/passports/008-third-party-logistics-provider.md`
