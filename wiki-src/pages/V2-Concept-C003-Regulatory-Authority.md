...
> Role of an Organization when exercising regulatory authority in a jurisdiction.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C003` |
| Domain | [[V2 Module 01 Ecosystem Organization|Ecosystem Organization]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:RegulatoryAuthorityRole` |
...
- Current SHACL source does not directly reference `cmpe:RegulatoryAuthorityRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** relational dependence on Organization and jurisdictional regulatory context.

## V1 lineage
- **Migration treatment:** Retained / refined
...
- Concept Evidence Passport: `v2/review/concepts/passports/003-regulatory-authority.md`
