...
> Commitment-bearing partnership relation connecting organizations in strategic collaboration.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C084` |
| Domain | [[V2 Module 15 Business Architecture|Business Architecture]] |
| Layer | Extension |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:StrategicPartnershipAgreement` |
...
- Current SHACL source does not directly reference `cmpe:StrategicPartnershipAgreement`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0014 → retain in extension
...
- Concept Evidence Passport: `v2/review/concepts/passports/084-strategic-partnership-agreement.md`
