...
> Numeric, coded, monetary, count, or quantity value associated with an observation result.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C047` |
...
- Current SHACL source does not directly reference `cmpe:MeasureValue`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/C1/P4
...
- Concept Evidence Passport: `v2/review/concepts/passports/047-measure-value.md`
