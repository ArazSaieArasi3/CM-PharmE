...
> Relation grounding that an evidence item supports an assertion or model claim.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C049` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:EvidenceSupport` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property evidenceRecord|`evidenceRecord`]] | cmpe:SourceRecord | explicit domain and range |
| Outgoing | [[V2 Object Property evidenceAssertion|`evidenceAssertion`]] | cmpe:Assertion | explicit domain and range |
...
- Current SHACL source references `cmpe:EvidenceSupport`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** Research traceability/all sources
- **Held-out evidence:** —
- **Other support:** M1/M2
...
## Structural example
`EvidenceSupport` — `evidenceRecord` → `cmpe:SourceRecord`
...
- Concept Evidence Passport: `v2/review/concepts/passports/049-evidence-support.md`
