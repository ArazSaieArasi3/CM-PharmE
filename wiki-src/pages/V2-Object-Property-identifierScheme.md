...
| Field | Value |
|---|---|
| IRI | `cmpe:identifierScheme` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C055 Identifier Assignment|IdentifierAssignment]] |
| Range | [[V2 Concept C054 Identifier Scheme|IdentifierScheme]] |
...
## Related concepts
- **Domain/source:** [[V2 Concept C055 Identifier Assignment|IdentifierAssignment]]
- **Range/target:** [[V2 Concept C054 Identifier Scheme|IdentifierScheme]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C055 Identifier Assignment|IdentifierAssignment]] — `identifierScheme` → [[V2 Concept C054 Identifier Scheme|IdentifierScheme]]
