...
## Purpose
Auditable transformation/provenance activity for an adapter execution.

## Keys and structure
- **Primary key:** `transformation_run_id`
- **Foreign keys:** 0
- **Provenance role:** transformation activity provenance
...
- `CHECK status (status IN ('running','completed','failed'))`
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/ProvenanceActivity` | class | direct | `transformation_run_id/public_id` | ETL run represented as provenance activity |
...
`{"transformation_run_id": "1001", "public_id": "syn-transformation-run-001", "adapter_name": "synthetic-adapter-name", "adapter_version": "synthetic-adapter-version", "started_at": "2026-01-15T10:00:00Z", "completed_at": "2026-01-15T10:00:00Z", "status": "completed", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
