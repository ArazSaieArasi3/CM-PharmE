...
> Role of an Organization responsible for pharmaceutical manufacturing or regulated manufacturing responsibility.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C004` |
| Domain | [[V2 Module 01 Ecosystem Organization|Ecosystem Organization]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ManufacturerRole` |
...
- Current SHACL source does not directly reference `cmpe:ManufacturerRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** contextual dependence on Organization and manufacturing responsibility.
...
- Concept Evidence Passport: `v2/review/concepts/passports/004-manufacturer.md`
