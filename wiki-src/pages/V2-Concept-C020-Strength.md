...
> Quantitative strength/concentration characteristic borne by a product presentation.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C020` |
| Domain | [[V2 Module 04 Pharmaceutical Product|Pharmaceutical Product]] |
| Layer | Core |
| OntoUML stereotype | Quality |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:Strength` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property hasStrength|`hasStrength`]] | MedicinalProductPresentation | explicit range and domain |
...
- Current SHACL source does not directly reference `cmpe:Strength`. This is a syntactic reference observation, not a completeness judgment.
...
## Structural example
`MedicinalProductPresentation` — `hasStrength` → `Strength`
...
- Concept Evidence Passport: `v2/review/concepts/passports/020-strength.md`
