...
| Field | Value |
|---|---|
| IRI | `cmpe:measureNumericValue` |
| Property type | OWL DatatypeProperty |
| Domain | [[V2 Concept C046 Observation Result|ObservationResult]] |
| Range | `xsd:decimal` |
...
## Related concepts
- **Domain:** [[V2 Concept C046 Observation Result|ObservationResult]]
- **Literal range:** `xsd:decimal`

## Structural example
[[V2 Concept C046 Observation Result|ObservationResult]] — `measureNumericValue` → `xsd:decimal`
