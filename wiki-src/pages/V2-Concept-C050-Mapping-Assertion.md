...
> Assertion stating an explicit source-to-canonical semantic mapping.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C050` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:MappingAssertion` |
...
- Current SHACL source does not directly reference `cmpe:MappingAssertion`. This is a syntactic reference observation, not a completeness judgment.
...
- Concept Evidence Passport: `v2/review/concepts/passports/050-mapping-assertion.md`
