...
| Field | Value |
|---|---|
| IRI | `cmpe:entryInScheme` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C023 Classification Entry|ClassificationEntry]] |
| Range | [[V2 Concept C022 Product Classification Scheme|ProductClassificationScheme]] |
| Formal layer | Core |
...
## Related concepts
- **Domain/source:** [[V2 Concept C023 Classification Entry|ClassificationEntry]]
- **Range/target:** [[V2 Concept C022 Product Classification Scheme|ProductClassificationScheme]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C023 Classification Entry|ClassificationEntry]] — `entryInScheme` → [[V2 Concept C022 Product Classification Scheme|ProductClassificationScheme]]
