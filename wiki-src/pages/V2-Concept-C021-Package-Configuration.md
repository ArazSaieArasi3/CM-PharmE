...
> Packaging or pack-quantity configuration associated with a product presentation.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C021` |
| Domain | [[V2 Module 04 Pharmaceutical Product|Pharmaceutical Product]] |
| Layer | Core |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:PackageConfiguration` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property hasPackageConfiguration|`hasPackageConfiguration`]] | MedicinalProductPresentation | explicit range and domain |
...
- Current SHACL source does not directly reference `cmpe:PackageConfiguration`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/P4
...
## Structural example
`MedicinalProductPresentation` — `hasPackageConfiguration` → `PackageConfiguration`
...
- Concept Evidence Passport: `v2/review/concepts/passports/021-package-configuration.md`
