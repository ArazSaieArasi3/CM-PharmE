...
## Purpose
Canonical pharmaceutical-substance identity layer.

## Provenance role
Source-normalized identity layer; strong identity claims remain bounded by mapping evidence.

## Physical structure
| Column | SQL type | Nullable | Key / constraint | Default |
|---|---|---|---|---|
| `substance_id` | `BIGSERIAL` | NO | PK | — |
| `public_id` | `TEXT` | NO | UNIQUE | — |
| `preferred_name` | `TEXT` | NO | — | — |
| `source_code` | `TEXT` | YES | — | — |
| `ontology_iri` | `TEXT` | NO | — | `'https://w3id.org/cm-pharme/2.0/PharmaceuticalSubstance'` |
...
|---|---|---|
| [[V2 Table medicinal_product|medicinal_product]] | `primary_substance_id` | YES |
...
|---|---|---|---|---|---|
| `M012` | `PharmaceuticalSubstance` | class | direct | `substance_id/public_id` | Substance identity layer |
...
|---|---|
| `substance_id` | `101` |
| `public_id` | `example:pharmaceutical_substance:001` |
| `preferred_name` | `Example Preferred Name` |
| `ontology_iri` | `https://w3id.org/cm-pharme/2.0/Example` |
| `source_code` | `example` |

## Common join paths
- Parent from child: `pharmaceutical_substance.substance_id` = `medicinal_product.primary_substance_id`.
