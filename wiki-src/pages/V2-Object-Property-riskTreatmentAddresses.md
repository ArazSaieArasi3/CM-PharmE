...
| Field | Value |
|---|---|
| IRI | `cmpe:riskTreatmentAddresses` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C078 Risk Treatment Activity|RiskTreatmentActivity]] |
| Range | `unspecified` |
| Formal layer | Extension |

## Semantic / review note
Treatment subject; range review required

## Related concepts
- **Domain/source:** [[V2 Concept C078 Risk Treatment Activity|RiskTreatmentActivity]]
