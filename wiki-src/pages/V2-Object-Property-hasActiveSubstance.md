...
| Field | Value |
|---|---|
| IRI | `cmpe:hasActiveSubstance` |
| Property type | OWL ObjectProperty |
| Domain | `unspecified` |
| Range | [[V2 Concept C017 Pharmaceutical Substance|PharmaceuticalSubstance]] |
| Formal layer | Core |

## Semantic / review note
Formal/compositional specification; domain review required

## Related concepts
- **Domain/source:** `unspecified`
- **Range/target:** [[V2 Concept C017 Pharmaceutical Substance|PharmaceuticalSubstance]]
