...
- **Range/target:** [[V2 Concept C001 Organization|Organization]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C013 Establishment Registration|EstablishmentRegistration]] — `registrationAuthority` → [[V2 Concept C001 Organization|Organization]]
