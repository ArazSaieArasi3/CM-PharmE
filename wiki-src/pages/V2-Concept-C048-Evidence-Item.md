...
> Role borne by an information object when serving as evidence for an assertion, mapping, or decision.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C048` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | RoleMixin |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:EvidenceItem` |
...
- Current SHACL source does not directly reference `cmpe:EvidenceItem`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0038 broad → generalize/W4 refine
...
- Concept Evidence Passport: `v2/review/concepts/passports/048-evidence-item.md`
