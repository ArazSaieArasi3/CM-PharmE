# listingResponsibleOrganization
...
| Field | Value |
|---|---|
| IRI | `cmpe:listingResponsibleOrganization` |
...
## Structural example
[[V2 Concept C025 Market Listing|MarketListing]] — `listingResponsibleOrganization` → [[V2 Concept C001 Organization|Organization]]
