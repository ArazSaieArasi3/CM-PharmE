...
> Occurrence of pharmaceutical manufacturing/processing involving relevant actors, sites, products, or substances.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C026` |
| Domain | [[V2 Module 05 Supply Operations|Supply Operations]] |
| Layer | Core |
| OntoUML stereotype | Event |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ManufacturingActivity` |
...
- Current SHACL source does not directly reference `cmpe:ManufacturingActivity`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0015 → refine/split
...
- Concept Evidence Passport: `v2/review/concepts/passports/026-manufacturing-activity.md`
