...
> Permission relation connecting authority, regulated party/activity, jurisdiction, and validity.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C014` |
| Domain | [[V2 Module 03 Regulatory Governance|Regulatory Governance]] |
| Layer | Core |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:RegulatoryAuthorization` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property authorizationAuthority|`authorizationAuthority`]] | cmpe:Organization | explicit domain and range |
| Outgoing | [[V2 Object Property authorizationParty|`authorizationParty`]] | unspecified | explicit domain; range unspecified |
| Outgoing | [[V2 Object Property authorizationJurisdiction|`authorizationJurisdiction`]] | cmpe:RegulatoryJurisdiction | explicit domain and range |
...
- Current SHACL source references `cmpe:RegulatoryAuthorization`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P3 / C2
- **Held-out evidence:** none registered
- **Other support:** O1 / O2 / M1 / M2
- **Review focus:** permission truth-maker, validity context, and distinction from establishment registration.

## V1 lineage
- **Migration treatment:** Refined / split
- See [[V1 to V2 Concept Migration]] and [[V1 to V2 Research Evolution]] for cross-version interpretation.

## Structural example
`RegulatoryAuthorization` — `authorizationAuthority` → `cmpe:Organization`
...
- Concept Evidence Passport: `v2/review/concepts/passports/014-regulatory-authorization.md`
