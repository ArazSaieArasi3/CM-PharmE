...
> Occurrence in which observation, measurement, reporting, or evidence-production takes place.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C045` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Event |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ObservationActivity` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property producesObservationResult|`producesObservationResult`]] | cmpe:ObservationResult | explicit domain and range |

Properties whose endpoint is formally unspecified are not inferred into this list.

## Constraints / SHACL relevance
- Protected conceptual distinction(s): `ObservationActivity ≠ ObservationResult`.
- Current SHACL source does not directly reference `cmpe:ObservationActivity`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/P5/C1 inherited
- **Held-out evidence:** —
- **Other support:** M1/M2
...
## Structural example
`ObservationActivity` — `producesObservationResult` → `cmpe:ObservationResult`
...
- Concept Evidence Passport: `v2/review/concepts/passports/045-observation-activity.md`
