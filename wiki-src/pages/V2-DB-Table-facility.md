...
## Purpose
Canonical physical/operational facility identity with optional geographic location.
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/Facility` | class | direct | `facility_id/public_id` | Physical/operational facility identity |
| `https://w3id.org/cm-pharme/2.0/locatedIn` | object_property | direct | `geography_id` | Facility physical location; not regulatory jurisdiction |

See [[V2 Ontology Reference]] for semantic definitions. Mapping authority remains `v2/data/mappings/ontology-rdb-mapping.csv`.

## Common joins
- `facility.geography_id` → `geography.geography_id`

## Safe synthetic row fragment
`{"facility_id": "1001", "public_id": "syn-facility-001", "preferred_name": "synthetic-preferred-name", "geography_id": "1001", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
