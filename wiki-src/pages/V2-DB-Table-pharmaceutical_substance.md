...
## Purpose
Canonical pharmaceutical substance identity.
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/PharmaceuticalSubstance` | class | direct | `substance_id/public_id` | Substance identity layer |
...
`{"substance_id": "1001", "public_id": "syn-pharmaceutical-substance-001", "preferred_name": "synthetic-preferred-name", "source_code": "synthetic-source-code", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
