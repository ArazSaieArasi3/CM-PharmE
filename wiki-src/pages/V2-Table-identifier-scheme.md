...
## Purpose
Identifier namespace/scheme definition.

## Provenance role
Scheme metadata; assignment provenance is stored in identifier_assignment.
...
|---|---|---|
| [[V2 Table identifier_assignment|identifier_assignment]] | `identifier_scheme_id` | NO |
...
|---|---|---|---|---|---|
| `M020` | `IdentifierScheme` | class | direct | `identifier_scheme_id` | Scheme separated from identifier lexical value |
...
|---|---|
| `identifier_scheme_id` | `101` |
| `public_id` | `example:identifier_scheme:001` |
| `ontology_iri` | `https://w3id.org/cm-pharme/2.0/Example` |
| `scheme_name` | `Example Scheme Name` |

## Common join paths
- Parent from child: `identifier_scheme.identifier_scheme_id` = `identifier_assignment.identifier_scheme_id`.
