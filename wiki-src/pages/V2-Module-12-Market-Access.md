...
## Purpose and scope
Financing, reimbursement/utilization and diagnosis-reference semantics needed to represent access and funding context.
...
|---|---|---|---|
| [[V2 Concept C071 Healthcare Financing Organization|Healthcare Financing Organization]] | Role | OWL Class | pending |
| [[V2 Concept C072 Reimbursement and Utilization Observation Result|Reimbursement and Utilization Observation Result]] | Subkind | OWL Class | pending |
| [[V2 Concept C073 Diagnosis Classification Reference|Diagnosis Classification Reference]] | Kind | OWL Class | pending |
