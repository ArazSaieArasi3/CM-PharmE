...
## Purpose
Relator/associative evidence link from SourceRecord to Assertion.

## Keys and structure
- **Primary key:** `evidence_support_id`
- **Foreign keys:** 2
- **Provenance role:** evidence-to-assertion provenance bridge
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/EvidenceSupport` | class | direct | `source_record_id↔assertion_id` | Relator linking source record and assertion |

See [[V2 Ontology Reference]] for semantic definitions. Mapping authority remains `v2/data/mappings/ontology-rdb-mapping.csv`.

## Common joins
- `evidence_support.source_record_id` → `source_record.source_record_id`
- `evidence_support.assertion_id` → `assertion.assertion_id`

## Safe synthetic row fragment
`{"evidence_support_id": "1001", "public_id": "syn-evidence-support-001", "source_record_id": "1001", "assertion_id": "1001", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
