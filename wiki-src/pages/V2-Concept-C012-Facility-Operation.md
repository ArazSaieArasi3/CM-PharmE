...
> Relational entity grounding operational responsibility between Organization and Facility.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C012` |
| Domain | [[V2 Module 02 Facility Operations|Facility Operations]] |
| Layer | Core |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:FacilityOperation` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property operationOrganization|`operationOrganization`]] | cmpe:Organization | explicit domain and range |
| Outgoing | [[V2 Object Property operationFacility|`operationFacility`]] | cmpe:Facility | explicit domain and range |
...
- Current SHACL source references `cmpe:FacilityOperation`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P2 / P3 / C2 inherited
- **Held-out evidence:** none registered
- **Other support:** M1 / M2
- **Review focus:** truth-maker need, mediated participants, and operational-responsibility semantics.

## V1 lineage
- **Migration treatment:** New W4 truth-maker
- See [[V1 to V2 Concept Migration]] and [[V1 to V2 Research Evolution]] for cross-version interpretation.

## Structural example
`FacilityOperation` — `operationOrganization` → `cmpe:Organization`
...
- Concept Evidence Passport: `v2/review/concepts/passports/012-facility-operation.md`
