...
> Occurrence in which risk, vulnerability, exposure, or consequence is assessed.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C075` |
| Domain | [[V2 Module 13 Risk Management|Risk Management]] |
| Layer | Extension |
| OntoUML stereotype | Event |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:RiskAssessmentActivity` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property riskAssessmentConcerns|`riskAssessmentConcerns`]] | unspecified | explicit domain; range unspecified |
...
- Current SHACL source does not directly reference `cmpe:RiskAssessmentActivity`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** V1/W1
- **Held-out evidence:** —
- **Other support:** R1/PR1/M1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0028 → refine/split
...
- Concept Evidence Passport: `v2/review/concepts/passports/075-risk-assessment-activity.md`
