...
> Information object representing a proposition in research, mapping, provenance, or KG layers.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C044` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:Assertion` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property evidenceAssertion|`evidenceAssertion`]] | EvidenceSupport | explicit range and domain |
| Incoming | [[V2 Object Property generatedAssertion|`generatedAssertion`]] | ProvenanceActivity | explicit range and domain |
...
- Current SHACL source references `cmpe:Assertion`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** Demonstrator C/all mappings
...
## Structural example
`EvidenceSupport` — `evidenceAssertion` → `Assertion`
...
- Concept Evidence Passport: `v2/review/concepts/passports/044-assertion.md`
