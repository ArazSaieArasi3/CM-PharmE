...
> Regulated Organization role engaged in wholesale pharmaceutical distribution.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C007` |
| Domain | [[V2 Module 01 Ecosystem Organization|Ecosystem Organization]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:WholesaleDistributorRole` |
...
- Current SHACL source does not directly reference `cmpe:WholesaleDistributorRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** anti-rigidity/context and separation from organization identity and distribution-site identity.
...
- Concept Evidence Passport: `v2/review/concepts/passports/007-wholesale-distributor.md`
