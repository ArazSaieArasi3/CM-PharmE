# contextClassificationJurisdiction
...
| Field | Value |
|---|---|
| IRI | `cmpe:contextClassificationJurisdiction` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C060 Contextual Medicine Classification Assignment|ContextualMedicineClassificationAssignment]] |
| Range | [[V2 Concept C015 Regulatory Jurisdiction|RegulatoryJurisdiction]] |
| Formal layer | Extension |

## Semantic / review note
Context participant

## Related concepts
- **Domain/source:** [[V2 Concept C060 Contextual Medicine Classification Assignment|ContextualMedicineClassificationAssignment]]
- **Range/target:** [[V2 Concept C015 Regulatory Jurisdiction|RegulatoryJurisdiction]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C060 Contextual Medicine Classification Assignment|ContextualMedicineClassificationAssignment]] — `contextClassificationJurisdiction` → [[V2 Concept C015 Regulatory Jurisdiction|RegulatoryJurisdiction]]
