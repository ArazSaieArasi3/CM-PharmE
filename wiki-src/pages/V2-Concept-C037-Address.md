...
> Structured/textual location description used for organization/facility location and entity resolution.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C037` |
...
- Current SHACL source does not directly reference `cmpe:Address`. This is a syntactic reference observation, not a completeness judgment.
...
- Concept Evidence Passport: `v2/review/concepts/passports/037-address.md`
