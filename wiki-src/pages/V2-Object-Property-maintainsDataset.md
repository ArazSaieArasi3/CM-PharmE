...
| Field | Value |
|---|---|
| IRI | `cmpe:maintainsDataset` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C040 Data Source|DataSourceResource]] |
| Range | [[V2 Concept C041 Dataset|Dataset]] |
| Formal layer | X-INFRA |

## Semantic / review note
Source stewardship/publication pattern

## Related concepts
- **Domain/source:** [[V2 Concept C040 Data Source|DataSourceResource]]
- **Range/target:** [[V2 Concept C041 Dataset|Dataset]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C040 Data Source|DataSourceResource]] — `maintainsDataset` → [[V2 Concept C041 Dataset|Dataset]]
