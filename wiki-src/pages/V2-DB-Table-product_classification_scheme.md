...
## Purpose
Classification-scheme identity such as ATC or another product classification system.

## Keys and structure
- **Primary key:** `classification_scheme_id`
- **Foreign keys:** 0
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/ProductClassificationScheme` | class | direct | `classification_scheme_id` | Classification scheme separated from product identity |
...
`{"classification_scheme_id": "1001", "public_id": "syn-product-classification-scheme-001", "scheme_name": "synthetic-scheme-name", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
