...
> Ingestion, transformation, normalization, or mapping activity generating derived artifacts/assertions.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C051` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Event |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ProvenanceActivity` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property usedSourceArtifact|`usedSourceArtifact`]] | unspecified | explicit domain; range unspecified |
| Outgoing | [[V2 Object Property generatedAssertion|`generatedAssertion`]] | cmpe:Assertion | explicit domain and range |
...
- Current SHACL source does not directly reference `cmpe:ProvenanceActivity`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** Demonstrator C
- **Held-out evidence:** H2 partial temporal/provenance support
- **Other support:** M2
...
## Structural example
`ProvenanceActivity` — `generatedAssertion` → `cmpe:Assertion`
...
- Concept Evidence Passport: `v2/review/concepts/passports/051-provenance-activity.md`
