...
> Quality expressing confidence or ambiguity attached to an entity-match assertion.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C057` |
| Domain | [[V2 Module 09 Entity Identity|Entity Identity]] |
| Layer | X-INFRA |
| OntoUML stereotype | Quality |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:MatchConfidence` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property hasMatchConfidence|`hasMatchConfidence`]] | EntityMatchAssertion | explicit range and domain |
...
- Current SHACL source does not directly reference `cmpe:MatchConfidence`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** Entity-resolution design
- **Held-out evidence:** —
- **Other support:** M1/M2
...
## Structural example
`EntityMatchAssertion` — `hasMatchConfidence` → `MatchConfidence`
...
- Concept Evidence Passport: `v2/review/concepts/passports/057-match-confidence.md`
