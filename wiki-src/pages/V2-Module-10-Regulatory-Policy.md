...
## Purpose and scope
Regulatory requirements and oversight structures that extend the core governance model with normative policy semantics.
...
|---|---|---|---|
| [[V2 Concept C058 Regulatory Requirement|Regulatory Requirement]] | Kind | OWL Class | pending |
| [[V2 Concept C059 Regulatory Oversight|Regulatory Oversight]] | Relator | OWL Class | pending |
