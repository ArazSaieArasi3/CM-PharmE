...
> Physical operational site distinct from the organization operating or owning it.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C009` |
| Domain | [[V2 Module 02 Facility Operations|Facility Operations]] |
| Layer | Core |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:Facility` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property operates|`operates`]] | Organization | explicit range and domain |
| Incoming | [[V2 Object Property operationFacility|`operationFacility`]] | FacilityOperation | explicit range and domain |

Properties whose endpoint is formally unspecified are not inferred into this list.

## Constraints / SHACL relevance
- Protected conceptual distinction(s): `Facility ≠ Organization`, `Facility ≠ GeographicFeature`.
- Current SHACL source references `cmpe:Facility`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P2 / P3 / C2
- **Held-out evidence:** H1 trial site exact
- **Other support:** O1 / O2 / M1 / M2
- **Review focus:** independent facility identity and separation from Organization and operational roles.
...
- Concept Evidence Passport: `v2/review/concepts/passports/009-facility.md`
