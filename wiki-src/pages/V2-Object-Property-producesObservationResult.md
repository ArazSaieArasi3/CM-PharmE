...
| Field | Value |
|---|---|
| IRI | `cmpe:producesObservationResult` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C045 Observation Activity|ObservationActivity]] |
| Range | [[V2 Concept C046 Observation Result|ObservationResult]] |
| Formal layer | Core |

## Semantic / review note
Event → information relation

## Related concepts
- **Domain/source:** [[V2 Concept C045 Observation Activity|ObservationActivity]]
- **Range/target:** [[V2 Concept C046 Observation Result|ObservationResult]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C045 Observation Activity|ObservationActivity]] — `producesObservationResult` → [[V2 Concept C046 Observation Result|ObservationResult]]
