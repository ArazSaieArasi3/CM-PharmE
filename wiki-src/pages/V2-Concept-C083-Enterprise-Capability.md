...
> Organizational disposition/capability represented in the optional BA view.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C083` |
| Domain | [[V2 Module 15 Business Architecture|Business Architecture]] |
| Layer | Extension |
| OntoUML stereotype | Mode |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:EnterpriseCapability` |
...
- Current SHACL source does not directly reference `cmpe:EnterpriseCapability`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0005 → retain in extension
...
- Concept Evidence Passport: `v2/review/concepts/passports/083-enterprise-capability.md`
