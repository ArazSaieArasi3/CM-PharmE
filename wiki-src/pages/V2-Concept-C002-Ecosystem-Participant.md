...
> Anti-rigid participation pattern for entities participating in pharmaceutical ecosystem relations or activities.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C002` |
...
| Formal IRI | `cmpe:EcosystemParticipant` |
...
- Current SHACL source does not directly reference `cmpe:EcosystemParticipant`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** anti-rigidity, allowed bearers, and separation from Organization identity.

## V1 lineage
- **Migration treatment:** Refined
...
- Concept Evidence Passport: `v2/review/concepts/passports/002-ecosystem-participant.md`
