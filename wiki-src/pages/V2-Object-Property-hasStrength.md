...
- **Range/target:** [[V2 Concept C020 Strength|Strength]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C018 Medicinal Product Presentation|MedicinalProductPresentation]] — `hasStrength` → [[V2 Concept C020 Strength|Strength]]
