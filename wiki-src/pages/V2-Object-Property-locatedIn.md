...
| Domain | `unspecified` |
| Range | [[V2 Concept C033 Geographic Feature|GeographicFeature]] |
| Formal layer | X-INFRA |

## Semantic / review note
Geographic context; domain review required

## Related concepts
- **Domain/source:** `unspecified`
- **Range/target:** [[V2 Concept C033 Geographic Feature|GeographicFeature]]
