# Research Process and Evolution Diagrams

> **Version scope:** Cross-version  
> **Status:** Stable-to-date / Evolving  
> **Updated:** 2026-09-24

This visual suite explains the CM-PharmE research journey without requiring a reader to learn internal workstream or checkpoint identifiers first. Internal repository controls remain available through provenance, while the diagrams use descriptive research language.
...
[Source](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/source/process/DGM-PRC-001--research-landscape.mmd) · [SVG](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/rendered/process/DGM-PRC-001--research-landscape.svg)
...
[Source](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/source/process/DGM-PRC-002--v1-research-process.mmd) · [SVG](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/rendered/process/DGM-PRC-002--v1-research-process.svg)
...
[Source](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/source/process/DGM-PRC-003--v2-research-process.mmd) · [SVG](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/rendered/process/DGM-PRC-003--v2-research-process.svg)
...
[Source](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/source/evolution/DGM-EVO-002--v1-v2-research-evolution.dot) · [SVG](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/rendered/evolution/DGM-EVO-002--v1-v2-research-evolution.svg)
...
[Source](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/source/architecture/DGM-ARC-002--evidence-to-evaluation-trace.mmd) · [SVG](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/rendered/architecture/DGM-ARC-002--evidence-to-evaluation-trace.svg)
...
[Source](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/source/architecture/DGM-ARC-003--publication-repository-wiki.mmd) · [SVG](https://github.com/ArazSaieArasi3/CM-PharmE/blob/main/wiki-src/diagrams/rendered/architecture/DGM-ARC-003--publication-repository-wiki.svg)

## Status boundary

At this synchronization point:
- V1 is the stable research/documentation baseline.
- V2 remains Stable-to-date / Evolving.
- E9 prospective expert evaluation is not complete.
- representative-task demonstrator evaluation remains open.
- semantic review remains active.
- integrated manuscript work remains active.
- no diagram in this suite implies final V2 release readiness.

## Diagram provenance

All six diagrams are governed by [[Diagram Standards and Inventory]] and `wiki-src/diagrams/manifest.json`.
...
- **Authoritative source:** V1 main research artifacts; V2 v2/research-program plus live issue state
- **Last synchronized:** 2026-09-24
- **Last synchronized ref:** V1 main; V2 `v2/research-program@1226b0a5484f8f5d3a8d214e0d0f52f066b88999`
- **Related issues/PRs:** #98, #159, #170, #171, #173, #228, #233
- **Evidence status:** Six-diagram explanatory projection; no new semantic/research result
- **Future refresh:** #212/#213/#214 as pending V2 evidence stabilizes
