...
## Provenance role
Canonical entity; source provenance follows identifiers/assertions/mappings where created.
...
|---|---|---|
| [[V2 Table facility_operation|facility_operation]] | `organization_id` | NO |
...
|---|---|---|---|---|---|
| `M009` | `Organization` | class | direct | `organization_id/public_id` | Organization identity not collapsed into Facility |
...
|---|---|
| `organization_id` | `101` |
| `public_id` | `example:organization:001` |
| `preferred_name` | `Example Preferred Name` |
| `ontology_iri` | `https://w3id.org/cm-pharme/2.0/Example` |

## Common join paths
- Parent from child: `organization.organization_id` = `facility_operation.organization_id`.
