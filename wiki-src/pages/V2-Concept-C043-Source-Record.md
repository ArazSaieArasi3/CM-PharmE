...
> Identifiable row, entry, document, or source record from which assertions/mappings derive.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C043` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:SourceRecord` |
...
|---|---|---|---|
| Incoming | [[V2 Object Property containsSourceRecord|`containsSourceRecord`]] | DatasetRelease | explicit range and domain |
| Incoming | [[V2 Object Property evidenceRecord|`evidenceRecord`]] | EvidenceSupport | explicit range and domain |

Properties whose endpoint is formally unspecified are not inferred into this list.

## Constraints / SHACL relevance
- Protected conceptual distinction(s): `SourceRecord ≠ MedicineShortageSituation`.
- Current SHACL source references `cmpe:SourceRecord`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1–P5
...
## Structural example
`DatasetRelease` — `containsSourceRecord` → `SourceRecord`
...
- Concept Evidence Passport: `v2/review/concepts/passports/043-source-record.md`
