...
| Field | Value |
|---|---|
| IRI | `cmpe:hasDatasetRelease` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C041 Dataset|Dataset]] |
| Range | [[V2 Concept C042 Dataset Release|DatasetRelease]] |
| Formal layer | X-INFRA |

## Semantic / review note
Dataset version/release pattern

## Related concepts
- **Domain/source:** [[V2 Concept C041 Dataset|Dataset]]
- **Range/target:** [[V2 Concept C042 Dataset Release|DatasetRelease]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C041 Dataset|Dataset]] — `hasDatasetRelease` → [[V2 Concept C042 Dataset Release|DatasetRelease]]
