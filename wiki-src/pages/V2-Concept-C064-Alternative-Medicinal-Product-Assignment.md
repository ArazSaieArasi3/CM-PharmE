...
> Relation grounding designation of one medicinal product as an alternative to another.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C064` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:AlternativeMedicineAssignment` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property alternativeProduct|`alternativeProduct`]] | cmpe:MedicinalProduct | explicit domain and range |
| Outgoing | [[V2 Object Property alternativeForProduct|`alternativeForProduct`]] | cmpe:MedicinalProduct | explicit domain and range |
...
- Current SHACL source does not directly reference `cmpe:AlternativeMedicineAssignment`. This is a syntactic reference observation, not a completeness judgment.
...
## Structural example
`AlternativeMedicineAssignment` — `alternativeProduct` → `cmpe:MedicinalProduct`
...
- Concept Evidence Passport: `v2/review/concepts/passports/064-alternative-medicinal-product-assignment.md`
