...
| Field | Value |
|---|---|
| IRI | `cmpe:classificationEntry` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C024 Product Classification Assignment|ProductClassificationAssignment]] |
...
## Related concepts
- **Domain/source:** [[V2 Concept C024 Product Classification Assignment|ProductClassificationAssignment]]
...
## Structural example
[[V2 Concept C024 Product Classification Assignment|ProductClassificationAssignment]] — `classificationEntry` → [[V2 Concept C023 Classification Entry|ClassificationEntry]]
