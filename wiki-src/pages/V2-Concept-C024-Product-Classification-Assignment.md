...
> Contextual assignment connecting a product/substance to a classification entry.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C024` |
| Domain | [[V2 Module 04 Pharmaceutical Product|Pharmaceutical Product]] |
| Layer | Core |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ProductClassificationAssignment` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property classificationEntity|`classificationEntity`]] | unspecified | explicit domain; range unspecified |
| Outgoing | [[V2 Object Property classificationEntry|`classificationEntry`]] | cmpe:ClassificationEntry | explicit domain and range |
...
- Current SHACL source references `cmpe:ProductClassificationAssignment`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P1/P2/P4/P5
- **Held-out evidence:** H2 exact; H3 partial
...
## Structural example
`ProductClassificationAssignment` — `classificationEntry` → `cmpe:ClassificationEntry`
...
- Concept Evidence Passport: `v2/review/concepts/passports/024-product-classification-assignment.md`
