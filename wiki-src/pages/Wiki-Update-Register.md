...
|---|---|---|---|---|---|---|---|---|
| 2026-09-24 | WB-2026.09.1 | Browser/theme-safe migration for all governed SVG diagrams | #260 | V1 semantic content unchanged | V2 semantic content unchanged | Documentation rendering-only | 20/20 governed SVGs normalized; explicit white canvas + #24292f foreground; 0 diagram-validation errors | Recheck rendered Wiki after publication |
