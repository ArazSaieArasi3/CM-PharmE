...
> Coordinate/geometry value used to locate a feature or facility.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C036` |
...
| Formal IRI | `cmpe:GeospatialPosition` |
...
- Current SHACL source does not directly reference `cmpe:GeospatialPosition`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P7
- **Held-out evidence:** —
- **Other support:** M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/036-geospatial-position.md`
