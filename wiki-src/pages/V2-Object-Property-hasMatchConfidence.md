...
| Field | Value |
|---|---|
| IRI | `cmpe:hasMatchConfidence` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C056 Entity Match Assertion|EntityMatchAssertion]] |
| Range | [[V2 Concept C057 Match Confidence|MatchConfidence]] |
...
## Related concepts
- **Domain/source:** [[V2 Concept C056 Entity Match Assertion|EntityMatchAssertion]]
- **Range/target:** [[V2 Concept C057 Match Confidence|MatchConfidence]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C056 Entity Match Assertion|EntityMatchAssertion]] — `hasMatchConfidence` → [[V2 Concept C057 Match Confidence|MatchConfidence]]
