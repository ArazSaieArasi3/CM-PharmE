...
> Relationship connecting authority with supervised organization/party under requirements/jurisdiction.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C059` |
| Domain | [[V2 Module 10 Regulatory Policy|Regulatory Policy]] |
| Layer | Extension |
| OntoUML stereotype | Relator |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:RegulatoryOversight` |
...
- Current SHACL source does not directly reference `cmpe:RegulatoryOversight`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P3/C2
- **Held-out evidence:** —
- **Other support:** PR1/O1/O2/M1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0004 → retain/refine
...
- Concept Evidence Passport: `v2/review/concepts/passports/059-regulatory-oversight.md`
