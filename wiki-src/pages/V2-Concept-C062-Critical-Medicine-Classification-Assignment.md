...
> Assignment stating that a medicine is critical under a defined regulatory/policy context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C062` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:CriticalMedicineClassification` |
...
- Current SHACL source does not directly reference `cmpe:CriticalMedicineClassification`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P5
- **Held-out evidence:** —
- **Other support:** O4/M1/M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/062-critical-medicine-classification-assignment.md`
