...
| Field | Value |
|---|---|
| IRI | `cmpe:authorizationAuthority` |
...
## Structural example
[[V2 Concept C014 Regulatory Authorization|RegulatoryAuthorization]] — `authorizationAuthority` → [[V2 Concept C001 Organization|Organization]]
