...
> Occurrence of pharmaceutical distribution, storage, handling, or logistics activity.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C027` |
| Domain | [[V2 Module 05 Supply Operations|Supply Operations]] |
| Layer | Core |
| OntoUML stereotype | Event |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:DistributionLogisticsActivity` |
...
- Current SHACL source does not directly reference `cmpe:DistributionLogisticsActivity`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0015/C0032 → refine/split
...
- Concept Evidence Passport: `v2/review/concepts/passports/027-pharmaceutical-logistics-activity.md`
