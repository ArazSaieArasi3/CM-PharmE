...
| Field | Value |
|---|---|
| IRI | `cmpe:hasDosageForm` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C018 Medicinal Product Presentation|MedicinalProductPresentation]] |
| Range | [[V2 Concept C019 Dosage Form Specification|DosageFormSpecification]] |
| Formal layer | Core |
...
## Related concepts
- **Domain/source:** [[V2 Concept C018 Medicinal Product Presentation|MedicinalProductPresentation]]
- **Range/target:** [[V2 Concept C019 Dosage Form Specification|DosageFormSpecification]]

## Formal characteristics
- No inverse/material/derived characteristic is asserted by the parsed statement.

## Structural example
[[V2 Concept C018 Medicinal Product Presentation|MedicinalProductPresentation]] — `hasDosageForm` → [[V2 Concept C019 Dosage Form Specification|DosageFormSpecification]]
