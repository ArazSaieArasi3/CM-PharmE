...
| Field | Value |
|---|---|
| IRI | `cmpe:dependencyDependent` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C065 Supply Dependency|SupplyDependency]] |
| Range | `unspecified` |
| Formal layer | Extension |

## Semantic / review note
Dependency endpoint; range review required

## Related concepts
- **Domain/source:** [[V2 Concept C065 Supply Dependency|SupplyDependency]]
