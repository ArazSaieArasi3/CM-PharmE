...
> Role borne by an entity when treated as an asset exposed to risk in an assessment context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C074` |
| Domain | [[V2 Module 13 Risk Management|Risk Management]] |
| Layer | Extension |
| OntoUML stereotype | RoleMixin |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:AssetAtRisk` |
...
- Current SHACL source does not directly reference `cmpe:AssetAtRisk`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** V1/W1 risk evidence
- **Held-out evidence:** —
- **Other support:** R1/M1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0028 indirect → W4 adapter
...
- Concept Evidence Passport: `v2/review/concepts/passports/074-asset-at-risk.md`
