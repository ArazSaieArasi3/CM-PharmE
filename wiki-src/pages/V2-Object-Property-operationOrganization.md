...
| Field | Value |
|---|---|
| IRI | `cmpe:operationOrganization` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C012 Facility Operation|FacilityOperation]] |
...
## Related concepts
- **Domain/source:** [[V2 Concept C012 Facility Operation|FacilityOperation]]
...
## Structural example
[[V2 Concept C012 Facility Operation|FacilityOperation]] — `operationOrganization` → [[V2 Concept C001 Organization|Organization]]
