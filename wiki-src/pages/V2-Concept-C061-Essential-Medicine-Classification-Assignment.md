...
> Assignment stating that a medicine is essential under a defined list, jurisdiction, and version.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C061` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:EssentialMedicineClassification` |

## Generalization
[[V2 Concept C060 Contextual Medicine Classification Assignment|ContextualMedicineClassificationAssignment]]
...
- Current SHACL source does not directly reference `cmpe:EssentialMedicineClassification`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P6
- **Held-out evidence:** H3 exact
- **Other support:** O5/M1/M2
...
- Concept Evidence Passport: `v2/review/concepts/passports/061-essential-medicine-classification-assignment.md`
