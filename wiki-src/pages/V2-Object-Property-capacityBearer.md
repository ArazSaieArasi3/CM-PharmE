...
| Field | Value |
|---|---|
| IRI | `cmpe:capacityBearer` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C029 Supply Capacity|SupplyCapacity]] |
| Range | `unspecified` |
| Formal layer | Core |

## Semantic / review note
Characterization bearer; range review required

## Related concepts
- **Domain/source:** [[V2 Concept C029 Supply Capacity|SupplyCapacity]]
