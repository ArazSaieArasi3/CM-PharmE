...
| Field | Value |
|---|---|
| IRI | `cmpe:disruptionAffects` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C066 Disruption Event|DisruptionEvent]] |
| Range | `unspecified` |
| Formal layer | Extension |

## Semantic / review note
Event participant; range review required

## Related concepts
- **Domain/source:** [[V2 Concept C066 Disruption Event|DisruptionEvent]]
