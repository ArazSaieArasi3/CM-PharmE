...
| Field | Value |
|---|---|
| IRI | `cmpe:containsSourceRecord` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C042 Dataset Release|DatasetRelease]] |
...
## Related concepts
- **Domain/source:** [[V2 Concept C042 Dataset Release|DatasetRelease]]
...
## Structural example
[[V2 Concept C042 Dataset Release|DatasetRelease]] — `containsSourceRecord` → [[V2 Concept C043 Source Record|SourceRecord]]
