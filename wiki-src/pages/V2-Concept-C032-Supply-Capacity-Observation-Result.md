...
> Information object recording evidence or assessment about supply capacity.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C032` |
| Domain | [[V2 Module 06 Ecosystem Observation|Ecosystem Observation]] |
| Layer | Core |
| OntoUML stereotype | Subkind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:SupplyCapacityObservationResult` |

## Generalization
[[V2 Concept C046 Observation Result|ObservationResult]]

## Principal formal relations
No object property declares this concept as an explicit OWL domain or range endpoint.

Properties whose endpoint is formally unspecified are not inferred into this list.

## Constraints / SHACL relevance
- Protected conceptual distinction(s): `SupplyCapacityObservationResult ≠ SupplyCapacity`.
- Current SHACL source does not directly reference `cmpe:SupplyCapacityObservationResult`. This is a syntactic reference observation, not a completeness judgment.
- See [[V2 Formal Ontology and SHACL]] for constraint semantics and validation scope.

## Evidence and provenance
- **Dataset/source evidence:** P5/ESMP/C1
- **Held-out evidence:** —
- **Other support:** PR1/O3/M1/M2
- **Review focus:** confirm the registered definition and stereotype against admitted evidence.

## V1 lineage
- **Migration treatment:** C0011 → refine/split
- See [[V1 to V2 Concept Migration]] and [[V1 to V2 Research Evolution]] for cross-version interpretation.

## Structural example
No explicit object-property domain/range example is selected for this concept.
...
- Concept Evidence Passport: `v2/review/concepts/passports/032-supply-capacity-observation-result.md`
