...
> Organization role responsible for product listing, labeling, or market responsibility in a source/jurisdiction.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C006` |
| Domain | [[V2 Module 01 Ecosystem Organization|Ecosystem Organization]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ProductResponsibleLabelerRole` |

## Generalization
[[V2 Concept C001 Organization|Organization]], [[V2 Concept C002 Ecosystem Participant|EcosystemParticipant]]
...
- Current SHACL source does not directly reference `cmpe:ProductResponsibleLabelerRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** contextual dependence and the boundary between listing/labeling responsibility and organization identity.
...
- Concept Evidence Passport: `v2/review/concepts/passports/006-product-responsible-organization.md`
