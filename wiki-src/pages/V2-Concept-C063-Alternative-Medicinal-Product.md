...
> Anti-rigid role of a product/presentation designated as an alternative in context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C063` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:AlternativeMedicinalProductRole` |

## Generalization
[[V2 Concept C016 Medicinal Product|MedicinalProduct]], [[V2 Concept C002 Ecosystem Participant|EcosystemParticipant]]
...
- Current SHACL source does not directly reference `cmpe:AlternativeMedicinalProductRole`. This is a syntactic reference observation, not a completeness judgment.
...
- Concept Evidence Passport: `v2/review/concepts/passports/063-alternative-medicinal-product.md`
