...
| Field | Value |
|---|---|
| IRI | `cmpe:riskAssessmentConcerns` |
| Property type | OWL ObjectProperty |
| Domain | [[V2 Concept C075 Risk Assessment Activity|RiskAssessmentActivity]] |
| Range | `unspecified` |
| Formal layer | Extension |

## Semantic / review note
Assessment subject; range review required

## Related concepts
- **Domain/source:** [[V2 Concept C075 Risk Assessment Activity|RiskAssessmentActivity]]
- **Range/target:** `unspecified`
