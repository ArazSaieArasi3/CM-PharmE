...
## Purpose
Canonical assertion target for evidence/provenance linkage.
...
|---|---|---|---|---|
| `https://w3id.org/cm-pharme/2.0/Assertion` | class | direct | `assertion_id/public_id` | Canonical assertion/evidence target |
...
`{"assertion_id": "1001", "public_id": "syn-assertion-001", "assertion_type": "synthetic-assertion-type", "subject_public_id": "synthetic-subject-public-id", "predicate_key": "synthetic-predicate-key", "object_lexical": "synthetic-object-lexical", "object_public_id": "synthetic-object-public-id", "ontology_iri": "https://w3id.org/cm-pharme/2.0/Example"}`
