...
> Information resource/source artifact from which datasets, records, or evidence are obtained.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C040` |
| Domain | [[V2 Module 08 Evidence Traceability|Evidence Traceability]] |
| Layer | X-INFRA |
| OntoUML stereotype | Kind |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:DataSourceResource` |
...
|---|---|---|---|
| Outgoing | [[V2 Object Property maintainsDataset|`maintainsDataset`]] | cmpe:Dataset | explicit domain and range |
...
- Concept Evidence Passport: `v2/review/concepts/passports/040-data-source.md`
