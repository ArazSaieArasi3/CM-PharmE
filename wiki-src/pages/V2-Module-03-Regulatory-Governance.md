...
## Purpose and scope
Jurisdictions, registrations and authorizations that establish regulatory standing for organizations, facilities and products.
...
|---|---|---|---|
| [[V2 Concept C013 Establishment Registration|Establishment Registration]] | Relator | OWL Class | pending |
| [[V2 Concept C014 Regulatory Authorization|Regulatory Authorization]] | Relator | OWL Class | pending |
| [[V2 Concept C015 Regulatory Jurisdiction|Regulatory Jurisdiction]] | Kind | OWL Class | pending |

## Relation patterns
| Property | Domain | Range | Review note |
|---|---|---|---|
| [[V2 Object Property registrationEntity|`registrationEntity`]] | EstablishmentRegistration | unspecified | Registered-entity participant; range review required |
| [[V2 Object Property registrationAuthority|`registrationAuthority`]] | EstablishmentRegistration | cmpe:Organization | Authority participant |
| [[V2 Object Property registrationJurisdiction|`registrationJurisdiction`]] | EstablishmentRegistration | cmpe:RegulatoryJurisdiction | Jurisdiction context |
| [[V2 Object Property authorizationAuthority|`authorizationAuthority`]] | RegulatoryAuthorization | cmpe:Organization | Authority participant |
| [[V2 Object Property authorizationParty|`authorizationParty`]] | RegulatoryAuthorization | unspecified | Authorized-party participant; range review required |
| [[V2 Object Property authorizationJurisdiction|`authorizationJurisdiction`]] | RegulatoryAuthorization | cmpe:RegulatoryJurisdiction | Jurisdiction context |
...
## Structural example
`EstablishmentRegistration` — `registrationAuthority` → `Organization`
