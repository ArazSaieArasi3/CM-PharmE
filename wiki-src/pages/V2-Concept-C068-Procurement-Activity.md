...
> Occurrence of pharmaceutical procurement/acquisition in a supply context.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C068` |
| Domain | [[V2 Module 11 Supply Resilience|Supply Resilience]] |
| Layer | Extension |
| OntoUML stereotype | Event |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ProcurementActivity` |
...
- Current SHACL source does not directly reference `cmpe:ProcurementActivity`. This is a syntactic reference observation, not a completeness judgment.
...
## V1 lineage
- **Migration treatment:** C0015 broad → split
...
- Concept Evidence Passport: `v2/review/concepts/passports/068-procurement-activity.md`
