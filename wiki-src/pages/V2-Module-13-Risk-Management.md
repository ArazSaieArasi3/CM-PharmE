...
## Purpose and scope
Assets at risk, assessment, vulnerability and treatment semantics for bounded pharmaceutical ecosystem risk analysis.
...
|---|---|---|---|
| [[V2 Concept C074 Asset at Risk|Asset at Risk]] | RoleMixin | OWL Class | pending |
| [[V2 Concept C075 Risk Assessment Activity|Risk Assessment Activity]] | Event | OWL Class | pending |
| [[V2 Concept C076 Vulnerability|Vulnerability]] | Mode | OWL Class | pending |
| [[V2 Concept C077 Risk Treatment Plan|Risk Treatment Plan]] | Kind | OWL Class | pending |
| [[V2 Concept C078 Risk Treatment Activity|Risk Treatment Activity]] | Event | OWL Class | pending |

## Relation patterns
| Property | Domain | Range | Review note |
|---|---|---|---|
| [[V2 Object Property riskAssessmentConcerns|`riskAssessmentConcerns`]] | RiskAssessmentActivity | unspecified | Assessment subject; range review required |
| [[V2 Object Property riskTreatmentAddresses|`riskTreatmentAddresses`]] | RiskTreatmentActivity | unspecified | Treatment subject; range review required |
