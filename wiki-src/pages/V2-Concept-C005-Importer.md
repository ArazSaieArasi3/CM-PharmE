...
> Regulated role of an Organization importing pharmaceutical goods into a jurisdiction.

## Ontological role
| Field | Value |
|---|---|
| Concept ID | `CMPE-V2-C005` |
| Domain | [[V2 Module 01 Ecosystem Organization|Ecosystem Organization]] |
| Layer | Core |
| OntoUML stereotype | Role |
| Formal entity type | OWL Class |
| Formal IRI | `cmpe:ImporterRole` |
...
- Current SHACL source does not directly reference `cmpe:ImporterRole`. This is a syntactic reference observation, not a completeness judgment.
...
- **Held-out evidence:** —
- **Other support:** —
- **Review focus:** organization dependence and jurisdiction-sensitive importer responsibility.
...
- Concept Evidence Passport: `v2/review/concepts/passports/005-importer.md`
